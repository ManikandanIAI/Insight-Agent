...
from tools.web_search_tools import tool_list
from agent_prompts.web_search_agent import SYSTEM_PROMPT
...
from llm.config import WebSearchConfig
...
class WebSearchAgent(BaseAgent):
    def __init__(self):
        super().__init__()
        self.model = get_llm(wsc.MODEL, wsc.TEMPERATURE, wsc.MAX_TOKENS)
        self.model_alt = get_llm_alt(wsc.ALT_MODEL, wsc.ALT_TEMPERATURE, wsc.ALT_MAX_TOKENS)
