...
#     def __init__(self, file: UploadFile, filename: str, file_id, status_dict: Dict[str, str], session_id: str, message_id: str):
...
#         status_dict = status_dict
    ...
    #     if file_id not in status_dict:
    #         status_dict[file_id] = {"file_name": filename, "updates": []}
    #     status_dict[file_id]["updates"].append(status)
    #     if content is not None:
    #         status_dict[file_id]["content"] = content
